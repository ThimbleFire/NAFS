...
public class EditorBase : EditorWindow
{
    ...
    protected Animation PaintAnimationLookup(Animation animation)
    {
        Animation v = (Animation)EditorGUI.ObjectField(new Rect(4, Y, position.width - Right, 20), animation, typeof(Animation), false); AddRow();
        return v;
    }
